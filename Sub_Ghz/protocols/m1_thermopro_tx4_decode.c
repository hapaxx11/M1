 ...
 * Original: lib/subghz/protocols/thermopro_tx4.c
 * Licensed under GPLv3
 *
 * m1_thermopro_tx4_decode.c
 * ThermoPro TX-4 weather sensor — 37 bits, PPM
...
uint8_t subghz_decode_thermopro_tx4(uint16_t p, uint16_t pulsecount)
{
