...
/*
 * m1_honda_static_decode.c
 *
 * Placeholder decoder for ProtoPirate "honda static".
...
uint8_t subghz_decode_honda_static(uint16_t protocol_index, uint16_t pulse_count)
{
    (void)protocol_index;
    (void)pulse_count;
