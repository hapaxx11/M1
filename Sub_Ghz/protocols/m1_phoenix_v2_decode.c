...
/*
*  m1_phoenix_v2_decode.c
*  M1 sub-ghz Phoenix_V2 52-bit decoding
*  te_short=427us, te_long=853us
*  After start bit: (LOW,HIGH) pairs: bit0=853L+427H, bit1=427L+853H
*/
...
uint8_t subghz_decode_phoenix_v2(uint16_t p, uint16_t pulsecount)
{
    ...
    /* pulse[0] = start bit HIGH (6×te_short ≈ 2562us); skip it.
     * Data begins at pulse[1] as (LOW, HIGH) pairs:
