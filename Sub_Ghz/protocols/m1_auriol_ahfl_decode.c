 ...
 * Original: lib/subghz/protocols/auriol_ahfl.c
 * Licensed under GPLv3
 *
 * m1_auriol_ahfl_decode.c
 * Auriol AHFL 433B2 IPX4 weather sensor — 42 bits, PPM
...
uint8_t subghz_decode_auriol_ahfl(uint16_t p, uint16_t pulsecount)
{
