                                 ...
                                 int *out_len, int timeout_sec)
{
	...
	/* Flush any residual FIFO / packing state before the first full-duplex
	 * transaction.  The brain (CD3) detection probe runs AFTER the half-duplex
	 ...
	 * resets the peripheral state machine and flushes the FIFOs so the first
