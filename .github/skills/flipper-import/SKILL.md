...
- [ ] Any scrollable list / menu UI uses Hapax font-aware helpers (`m1_menu_font()`, `m1_menu_item_h()`, `m1_menu_max_visible()`, `M1_MENU_VIS()`) — see the [`ui-scene-architecture`](../ui-scene-architecture/SKILL.md#user-configurable-font-size--m1_menu_style) skill ("User-Configurable Font Size")
