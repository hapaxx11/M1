...
static const char s_default_config[] =
	...
	"# Category: firmware (M1 STM32 firmware) or esp32 (ESP32-C6 coprocessor firmware)\n"
	"#\n"
	...
	"Owner: bedge117\n"
	"Repo: m1-esp32-brain\n"
	"Asset_filter: factory_m1-esp32-brain.bin\n"
	"Exclude_filter:\n"
	"Category: esp32\n"
	"Max_releases: 5\n"
	"\n"
                                      ...
                                      http_status_t *out_status)
{
	...
	if (*p != '[')
	{
		if (out_status) *out_status = HTTP_ERR_PARSE_FAIL;
		return 0;
	}
	p++;
