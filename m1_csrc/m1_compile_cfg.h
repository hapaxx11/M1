...
/* Optional: External IR uses PA9/PA10; define this to free them from USART1.
 * Effect: disables the USART1 serial debug console (USB-CDC/RPC unaffected).
 */
/* #define M1_EXT_IR_FREE_UART1 */
