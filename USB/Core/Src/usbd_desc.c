...
#else
#define USBD_PRODUCT_HS_STRING        "HapaxM1_MSC_CDC HS"
#define USBD_PRODUCT_FS_STRING        "HapaxM1_MSC_CDC FS"
#define USBD_CONFIGURATION_HS_STRING  "HapaxM1_MSC_CDC HS Config"
#define USBD_INTERFACE_HS_STRING      "HapaxM1_MSC_CDC HS"
#define USBD_CONFIGURATION_FS_STRING  "HapaxM1_MSC_CDC FS Config"
#define USBD_INTERFACE_FS_STRING      "HapaxM1_MSC_CDC FS"
#endif // #if 0
